    ...
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-orange-100/50 bg-white/95 backdrop-blur-xl shadow-lg">
      ...
      <div className="ttg-container">
        <div className="flex items-center justify-between gap-6 py-4">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <Link 
              href="/contact" 
              className="hidden sm:inline-flex items-center gap-2 px-4 md:px-5 py-2 md:py-2.5 text-xs md:text-sm font-bold text-white bg-gradient-to-r from-orange-500 to-amber-500 rounded-full shadow-md shadow-orange-500/30 hover:shadow-lg hover:shadow-orange-500/40 hover:scale-105 transition-all whitespace-nowrap"
            >
              Book Demo
            </Link>
            <button 
              ...
              className="lg:hidden p-2.5 text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-colors active:scale-95"
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden">
          ...
          {/* Menu Panel */}
          <div className="fixed top-[72px] right-0 bottom-0 w-[85%] max-w-sm bg-white z-[70] overflow-y-auto shadow-2xl transform transition-transform duration-300 ease-out">
            ...
            {navItems.map((item) => (
              <Link
                ...
                href={item.href}
                onClick={() => setIsMobileMenuOpen(false)}
                className="block px-4 py-3 text-base font-semibold text-slate-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-colors"
              >
                {item.label}
              </Link>
            ))}
            ...
            <div className="pt-6 space-y-3 border-t border-slate-200 mt-6">
              <Link
                href="/contact"
                onClick={() => setIsMobileMenuOpen(false)}
                className="block w-full text-center px-6 py-3 text-base font-bold text-white bg-gradient-to-r from-orange-500 to-amber-500 rounded-full shadow-lg shadow-orange-500/30"
              >
                Book Free Demo
              </Link>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full px-6 py-3 text-base font-semibold text-orange-600 bg-orange-50 rounded-full hover:bg-orange-100 transition-colors"
              >
